...
const AppLive = () => {
  ...
  return (
    <div className="AllDemo">
      <h2 className="Heading">SCALE DOWN-UP</h2>
      <div className="Description">
        <p>
          The is the reverse of demo 4: the submenu in this demo will scale down
          from the front while the current level scales down and fades out.
        </p>
      </div>
      <div className="Demo">
